...
Menu::Menu() {
    ...
    int rampacId = addNode(rootId, "RAMPAC", Category, -1, MENU_BIN0);
    addNode(rampacId, "Insert", Property, ID_LOAD_BINARY1);
    addNode(rampacId, "Recent", Property, ID_RECENT_BINARY1);

    int deviceId = addNode(rootId, "Device", Category, -1);
    int bootId = addNode(deviceId, "Boot", Category, -1);
    addNode(bootId, "T-BASIC Ver 1.0", Property, ID_VM_BOOT_MODE0);
    addNode(bootId, "T-BASIC Ver 1.1", Property, ID_VM_BOOT_MODE1);
    addNode(bootId, "OA-BASIC (Disk)", Property, ID_VM_BOOT_MODE2);
    addNode(bootId, "OA-BASIC", Property, ID_VM_BOOT_MODE3);
    addNode(bootId, "MINI PASCAL", Property, ID_VM_BOOT_MODE4);

    int deviceType = addNode(deviceId, "Device", Category, -1);
    addNode(deviceType, "RAMPAC", Property, ID_VM_DEVICE_TYPE0);
    addNode(deviceType, "Kanji ROM", Property, ID_VM_DEVICE_TYPE1);
    addNode(deviceType, "Joystick", Property, ID_VM_DEVICE_TYPE2);
