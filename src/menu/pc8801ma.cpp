...
Menu::Menu() {
    ...
    int fd1Id = addNode(rootId, "5inch-FD1", Category, -1, MENU_FDD0);
    ...
    int fd2Id = addNode(rootId, "5inch-FD2", Category, -1, MENU_FDD1);
    ...
    int fd3Id = addNode(rootId, "8inch-FD1", Category, -1, MENU_FDD2);
    ...
    int fd4Id = addNode(rootId, "8inch-FD2", Category, -1, MENU_FDD3);
    ...
    int cdRomId = addNode(rootId, "CD-ROM", Category, -1, MENU_CD0);
    addNode(cdRomId, "Insert", Property, ID_OPEN_COMPACT_DISC1);
    addNode(cdRomId, "Eject", Property, ID_CLOSE_COMPACT_DISC1);
    addNode(cdRomId, "Recent", Property, ID_RECENT_COMPACT_DISC1);

    int deviceId = addNode(rootId, "Device", Category, -1);
    int bootId = addNode(deviceId, "Boot", Category, -1);
    addNode(bootId, "N88-V1(S) mode", Property, ID_VM_BOOT_MODE0);
    addNode(bootId, "N88-V1(H) mode", Property, ID_VM_BOOT_MODE1);
    addNode(bootId, "N88-V2 mode", Property, ID_VM_BOOT_MODE2);
    addNode(bootId, "N mode", Property, ID_VM_BOOT_MODE3);
    addNode(bootId, "N88-V2(CD) mode", Property, ID_VM_BOOT_MODE4);

    int cpuId = addNode(deviceId, "CPU", Category, -1);
    addNode(cpuId, "Z80 8MHz", Property, ID_VM_CPU_TYPE0);
    addNode(cpuId, "Z80 4MHz", Property, ID_VM_CPU_TYPE1);
    addNode(cpuId, "Z80 8MHz (FE2/MC)", Property, ID_VM_CPU_TYPE2);

    int dipSwitchId = addNode(deviceId, "DIP Switch", Category, -1);
    addNode(dipSwitchId, "Memory Wait", Property, ID_VM_DIPSWITCH0);

    int floppyDriveId = addNode(deviceId, "Floppy Drive", Category, -1);
    addNode(floppyDriveId, "5inch FD", Property, ID_VM_DIPSWITCH6);
    addNode(floppyDriveId, "8inch FD", Property, ID_VM_DIPSWITCH7);

    int joystickId = addNode(deviceId, "Joystick", Category, -1);
    addNode(joystickId, "Joystick", Property, ID_VM_JOYSTICK_TYPE0);
    addNode(joystickId, "Bus Mouse", Property, ID_VM_JOYSTICK_TYPE1);

    int soundId = addNode(deviceId, "Sound", Category, -1);
    addNode(soundId, "OPNA", Property, ID_VM_SOUND_TYPE0);
    addNode(soundId, "OPN", Property, ID_VM_SOUND_TYPE1);
    addNode(soundId, "OPN+OPNA", Property, ID_VM_SOUND_TYPE2);
    addNode(soundId, "OPN+OPN", Property, ID_VM_SOUND_TYPE3);
    addNode(soundId, "OPNA+OPNA", Property, ID_VM_SOUND_TYPE4);
    addNode(soundId, "OPNA+OPN", Property, ID_VM_SOUND_TYPE5);
    addNode(soundId, "HMB-20", Property, ID_VM_DIPSWITCH1);
    addNode(soundId, "GSX-8800", Property, ID_VM_DIPSWITCH2);
    addNode(soundId, "PCG-8100", Property, ID_VM_DIPSWITCH3);
    addNode(soundId, "CMD SING", Property, ID_VM_DIPSWITCH4);
    ...
    addNode(displayId, "Set Scanline Automatically", Property, ID_VM_MONITOR_SCANLINE_AUTO);
    ...
    addNode(printerId, "JAST SOUND", Property, ID_VM_PRINTER_TYPE2);
    addNode(printerId, "None", Property, ID_VM_PRINTER_TYPE3);

    int specialFeaturesId = addNode(deviceId, "Special Features", Category, -1);
    addNode(specialFeaturesId, "M88 DiskDrv", Property, ID_VM_DIPSWITCH8);
    addNode(specialFeaturesId, "QUASIS88 Pesudo CMT", Property, ID_VM_DIPSWITCH9);
