...
Menu::Menu() {
    ...
    int hd3Id = addNode(rootId, "HD3", Category, -1, MENU_HDD2);
    int hd4Id = addNode(rootId, "HD4", Category, -1, MENU_HDD3);
    ...
    addNode(hd1Id, "Mount Blank 20MB Disk", Property, ID_OPEN_BLANK_20MB_1024_HD1);
    ...
    addNode(hd2Id, "Mount Blank 20MB Disk", Property, ID_OPEN_BLANK_20MB_1024_HD2);
    addNode(hd2Id, "Recent", Property, ID_RECENT_HD2);

    // HD3 メニューを作成
    addNode(hd3Id, "Mount", Property, ID_OPEN_HD3);
    addNode(hd3Id, "Unmount", Property, ID_CLOSE_HD3);
    addNode(hd3Id, "Mount Blank 20MB Disk", Property, ID_OPEN_BLANK_20MB_1024_HD3);
    addNode(hd3Id, "Recent", Property, ID_RECENT_HD3);

    // HD4 メニューを作成
    addNode(hd4Id, "Mount", Property, ID_OPEN_HD4);
    addNode(hd4Id, "Unmount", Property, ID_CLOSE_HD4);
    addNode(hd4Id, "Mount Blank 20MB Disk", Property, ID_OPEN_BLANK_20MB_1024_HD4);
    addNode(hd4Id, "Recent", Property, ID_RECENT_HD4);
