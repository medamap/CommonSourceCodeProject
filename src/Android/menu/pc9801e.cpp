...
Menu::Menu() {
    ...
    int recentFd1Id = addNode(fd1mbId1, "Recent", Category, -1);
    ...
    // 640KB-FD1 メニューを作成
    addNode(fd640kbId1, "Insert", Property, ID_OPEN_FD3);
    addNode(fd640kbId1, "Eject", Property, ID_CLOSE_FD3);
    addNode(fd640kbId1, "Insert Blank 2DD Disk", Property, ID_OPEN_BLANK_2DD_FD3);
    addNode(fd640kbId1, "Write Protected", Property, ID_WRITE_PROTECT_FD3);
    addNode(fd640kbId1, "Correct Timing", Property, ID_CORRECT_TIMING_FD3);
    addNode(fd640kbId1, "Ignore CRC Errors", Property, ID_IGNORE_CRC_FD3);
    addNode(fd640kbId1, "Recent", Property, ID_RECENT_FD3);

    // FD2 メニューを作成
    addNode(fd640kbId2, "Insert", Property, ID_OPEN_FD4);
    addNode(fd640kbId2, "Eject", Property, ID_CLOSE_FD4);
    addNode(fd640kbId2, "Insert Blank 2DD Disk", Property, ID_OPEN_BLANK_2DD_FD4);
    addNode(fd640kbId2, "Write Protected", Property, ID_WRITE_PROTECT_FD4);
    addNode(fd640kbId2, "Correct Timing", Property, ID_CORRECT_TIMING_FD4);
    addNode(fd640kbId2, "Ignore CRC Errors", Property, ID_IGNORE_CRC_FD4);
    addNode(fd640kbId2, "Recent", Property, ID_RECENT_FD4);

    // 320KB-FD1 メニューを作成
    addNode(fd320kbId1, "Insert", Property, ID_OPEN_FD5);
    addNode(fd320kbId1, "Eject", Property, ID_CLOSE_FD5);
    addNode(fd320kbId1, "Insert Blank 2D Disk", Property, ID_OPEN_BLANK_2D_FD5);
    addNode(fd320kbId1, "Write Protected", Property, ID_WRITE_PROTECT_FD5);
    addNode(fd320kbId1, "Correct Timing", Property, ID_CORRECT_TIMING_FD5);
    addNode(fd320kbId1, "Ignore CRC Errors", Property, ID_IGNORE_CRC_FD5);
    addNode(fd320kbId1, "Recent", Property, ID_RECENT_FD5);

    // FD2 メニューを作成
    addNode(fd320kbId2, "Insert", Property, ID_OPEN_FD6);
    addNode(fd320kbId2, "Eject", Property, ID_CLOSE_FD6);
    addNode(fd320kbId2, "Insert Blank 2D Disk", Property, ID_OPEN_BLANK_2D_FD6);
    addNode(fd320kbId2, "Write Protected", Property, ID_WRITE_PROTECT_FD6);
    addNode(fd320kbId2, "Correct Timing", Property, ID_CORRECT_TIMING_FD6);
    addNode(fd320kbId2, "Ignore CRC Errors", Property, ID_IGNORE_CRC_FD6);
    addNode(fd320kbId2, "Recent", Property, ID_RECENT_FD6);
    ...
    addNode(cpuId, "8086 8MHz", Property, ID_VM_CPU_TYPE0);
    addNode(cpuId, "8086 5MHz", Property, ID_VM_CPU_TYPE1);

    addNode(dipId, "SW 2-1", Property, ID_VM_DIPSWITCH16);
    addNode(dipId, "SW 2-2 (Terminal)", Property, ID_VM_DIPSWITCH17);
    addNode(dipId, "SW 2-3 (80 Columns)", Property, ID_VM_DIPSWITCH18);
    addNode(dipId, "SW 2-4 (25 Lines)", Property, ID_VM_DIPSWITCH19);
    addNode(dipId, "SW 2-5 (Hold Memory Switch)", Property, ID_VM_DIPSWITCH20);
    addNode(dipId, "SW 2-6", Property, ID_VM_DIPSWITCH21);
    addNode(dipId, "SW 2-7", Property, ID_VM_DIPSWITCH22);
    addNode(dipId, "SW 2-8", Property, ID_VM_DIPSWITCH23);

    addNode(fdId, "1MB-FD", Property, ID_VM_DIPSWITCH0);
    addNode(fdId, "640KB-FD", Property, ID_VM_DIPSWITCH1);
    addNode(fdId, "320KB-FD", Property, ID_VM_DIPSWITCH2);
