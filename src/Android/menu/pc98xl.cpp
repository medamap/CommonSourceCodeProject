...
Menu::Menu() {
    ...
    // Host メニューを作成
    int recId = addNode(hostId, "Rec", Category, -1);
    ...
    addNode(recId, "Rec Movie 60fps", Property, ID_HOST_REC_MOVIE_60FPS);
    addNode(recId, "Rec Movie 30fps", Property, ID_HOST_REC_MOVIE_30FPS);
    addNode(recId, "Rec Movie 15fps", Property, ID_HOST_REC_MOVIE_15FPS);
    addNode(recId, "Rec Sound", Property, ID_HOST_REC_SOUND);
    addNode(recId, "Stop", Property, ID_HOST_REC_STOP);
    addNode(recId, "Capture Screen", Property, ID_HOST_CAPTURE_SCREEN);
