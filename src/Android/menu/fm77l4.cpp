...
Menu::Menu() {
    ...
    addNode(bootId, "MMR", Property, ID_VM_BOOT_MODE2);

    int cpuId = addNode(deviceId, "CPU", Category, -1);
    addNode(cpuId, "68B09 2.0MHz", Property, ID_VM_CPU_TYPE0);
    addNode(cpuId, "68B09 1.2MHz", Property, ID_VM_CPU_TYPE1);

    int optionId = addNode(deviceId, "Option", Category, -1);
    addNode(optionId, "Cycle Steal", Property, ID_VM_DIPSWITCH0);
    addNode(optionId, "Extra RAM", Property, ID_VM_DIPSWITCH1);
    ...
    addNode(soundId, "PSG+OPN", Property, ID_VM_SOUND_TYPE1);
    addNode(soundId, "PSG+WHG", Property, ID_VM_SOUND_TYPE2);
    addNode(soundId, "PSG+OPN+WHG", Property, ID_VM_SOUND_TYPE3);
    addNode(soundId, "PSG+THG", Property, ID_VM_SOUND_TYPE4);
    addNode(soundId, "PSG+OPN+THG", Property, ID_VM_SOUND_TYPE5);
    addNode(soundId, "PSG+WHG+THG", Property, ID_VM_SOUND_TYPE6);
    addNode(soundId, "PSG+OPN+WHG+THG", Property, ID_VM_SOUND_TYPE7);
