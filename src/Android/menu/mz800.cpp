...
Menu::Menu() {
    ...
    addNode(controlId, "Save State", Category, -1);
    addNode(controlId, "Load State", Category, -1);
    ...
    addNode(bootId, "MZ-800", Property, ID_VM_BOOT_MODE0);
    addNode(bootId, "MZ-700", Property, ID_VM_BOOT_MODE1);
    ...
    addNode(displayId, "Color", Property, ID_VM_MONITOR_TYPE0);
    addNode(displayId, "Monochrome", Property, ID_VM_MONITOR_TYPE1);
