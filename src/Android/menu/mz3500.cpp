...
Menu::Menu() {
    ...
    addNode(controlId, "Halt", Property, ID_SPECIAL_RESET);
    ...
    int recentFd1Id = addNode(fd1Id, "Recent", Category, -1);
    ...
    int recentFd2Id = addNode(fd2Id, "Recent", Category, -1);
    ...
    // DIP Switch メニューを作成
    addNode(dipSwitchId, "SW4: Period for Decimal Point", Property, ID_VM_DIPSWITCH3);
    addNode(dipSwitchId, "FD1: Normally Capital Letter", Property, ID_VM_DIPSWITCH7);
    addNode(dipSwitchId, "P/M: 3500 CG for 200 Line CRT", Property, ID_VM_DIPSWITCH8);

    // Sound メニューを作成
    addNode(soundId, "Play FDD Noise", Property, ID_VM_SOUND_NOISE_FDD);

    // Display メニューを作成
    addNode(displayId, "400 Lines, Color", Property, ID_VM_MONITOR_TYPE0);
    addNode(displayId, "400 Lines, Green", Property, ID_VM_MONITOR_TYPE1);
    addNode(displayId, "200 Lines, Color", Property, ID_VM_MONITOR_TYPE2);
    addNode(displayId, "200 Lines, Green", Property, ID_VM_MONITOR_TYPE3);
