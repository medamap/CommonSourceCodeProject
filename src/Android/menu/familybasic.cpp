...
Menu::Menu() {
    ...
    addNode(bootId, "BASIC V2", Property, ID_VM_BOOT_MODE0);
    addNode(bootId, "BASIC V3", Property, ID_VM_BOOT_MODE1);
    addNode(bootId, "Playbox BASIC", Property, ID_VM_BOOT_MODE2);
    addNode(bootId, "VRC7 BASIC V2", Property, ID_VM_BOOT_MODE3);
    addNode(bootId, "VRC7 BASIC V3", Property, ID_VM_BOOT_MODE4);
    addNode(bootId, "MMC5 BASIC V3", Property, ID_VM_BOOT_MODE5);
