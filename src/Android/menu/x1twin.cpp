...
Menu::Menu() {
    ...
    addNode(screenId, "Window Stretch 1", Category, ID_SCREEN_WINDOW_STRETCH);
    addNode(screenId, "Window Stretch 2", Category, ID_SCREEN_WINDOW_ASPECT);
    addNode(screenId, "Fullscreen Stretch 1", Category, ID_SCREEN_FULLSCREEN_DOTBYDOT);
    addNode(screenId, "Fullscreen Stretch 2", Category, ID_SCREEN_FULLSCREEN_STRETCH);
    addNode(screenId, "Fullscreen Stretch 3", Category, ID_SCREEN_FULLSCREEN_ASPECT);
    addNode(screenId, "Fullscreen Stretch 4", Category, ID_SCREEN_FULLSCREEN_FILL);
