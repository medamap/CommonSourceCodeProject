...
Menu::Menu() {
    ...
    int soundId = addNode(hostId, "Sound", Category, -1);
    addNode(soundId, "Switch On / Off", Property, ID_SOUND_ON);
    addNode(soundId, "2000Hz", Property, ID_SOUND_FREQ0);
    addNode(soundId, "4000Hz", Property, ID_SOUND_FREQ1);
    addNode(soundId, "8000Hz", Property, ID_SOUND_FREQ2);
    addNode(soundId, "11025Hz", Property, ID_SOUND_FREQ3);
    addNode(soundId, "22050Hz", Property, ID_SOUND_FREQ4);
    addNode(soundId, "44100Hz", Property, ID_SOUND_FREQ5);
    addNode(soundId, "48000Hz", Property, ID_SOUND_FREQ6);
    addNode(soundId, "96000Hz", Property, ID_SOUND_FREQ7);
    addNode(soundId, "50msec", Property, ID_SOUND_LATE0);
    addNode(soundId, "100msec", Property, ID_SOUND_LATE1);
    addNode(soundId, "200msec", Property, ID_SOUND_LATE2);
    addNode(soundId, "300msec", Property, ID_SOUND_LATE3);
    addNode(soundId, "400msec", Property, ID_SOUND_LATE4);
    addNode(soundId, "Realtime Mix", Property, ID_SOUND_STRICT_RENDER);
    addNode(soundId, "Light Weight Mix", Property, ID_SOUND_LIGHT_RENDER);
    addNode(soundId, "Volume", Property, ID_SOUND_VOLUME);
    ...
    addNode(inputId, "Joystick #4", Property, ID_INPUT_JOYSTICK4);
