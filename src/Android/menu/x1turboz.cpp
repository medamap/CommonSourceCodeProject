...
Menu::Menu() {
    ...
    int mouseId = addNode(hostId, "Mouse", Category, -1);
    addNode(mouseId, "Mouse Sensitive 10", Property, ID_MOUSE_SENSITIVE_10);
    addNode(mouseId, "Mouse Sensitive 9", Property, ID_MOUSE_SENSITIVE_9);
    addNode(mouseId, "Mouse Sensitive 8", Property, ID_MOUSE_SENSITIVE_8);
    addNode(mouseId, "Mouse Sensitive 7", Property, ID_MOUSE_SENSITIVE_7);
    addNode(mouseId, "Mouse Sensitive 6", Property, ID_MOUSE_SENSITIVE_6);
    addNode(mouseId, "Mouse Sensitive 5", Property, ID_MOUSE_SENSITIVE_5);
    addNode(mouseId, "Mouse Sensitive 4", Property, ID_MOUSE_SENSITIVE_4);
    addNode(mouseId, "Mouse Sensitive 3", Property, ID_MOUSE_SENSITIVE_3);
    addNode(mouseId, "Mouse Sensitive 2", Property, ID_MOUSE_SENSITIVE_2);
    addNode(mouseId, "Mouse Sensitive 1", Property, ID_MOUSE_SENSITIVE_1);
    addNode(mouseId, "Mouse Sensitive 0", Property, ID_MOUSE_SENSITIVE_0);
    ...
    int soundRateId = addNode(hostId, "Sound", Category, -1);
    addNode(soundRateId, "Switch On / Off", Property, ID_SOUND_ON);
    addNode(soundRateId, "2000Hz", Property, ID_SOUND_FREQ0);
    addNode(soundRateId, "4000Hz", Property, ID_SOUND_FREQ1);
    addNode(soundRateId, "8000Hz", Property, ID_SOUND_FREQ2);
    addNode(soundRateId, "11025Hz", Property, ID_SOUND_FREQ3);
    addNode(soundRateId, "22050Hz", Property, ID_SOUND_FREQ4);
    addNode(soundRateId, "44100Hz", Property, ID_SOUND_FREQ5);
    addNode(soundRateId, "62500Hz", Property, ID_SOUND_FREQ6);
    addNode(soundRateId, "96000Hz", Property, ID_SOUND_FREQ7);
    addNode(soundRateId, "50msec", Property, ID_SOUND_LATE0);
    addNode(soundRateId, "100msec", Property, ID_SOUND_LATE1);
    addNode(soundRateId, "200msec", Property, ID_SOUND_LATE2);
    addNode(soundRateId, "300msec", Property, ID_SOUND_LATE3);
    addNode(soundRateId, "400msec", Property, ID_SOUND_LATE4);
    addNode(soundRateId, "Realtime Mix", Property, ID_SOUND_STRICT_RENDER);
    addNode(soundRateId, "Light Weight Mix", Property, ID_SOUND_LIGHT_RENDER);
    addNode(soundRateId, "Volume", Property, ID_SOUND_VOLUME);
