...
Menu::Menu() {
    ...
    addNode(controlId, "Debug 80286", Property, ID_OPEN_DEBUGGER0);
    addNode(controlId, "Debug V30", Property, ID_OPEN_DEBUGGER1);
    ...
    // CPU メニューを作成
    addNode(cpuId, "80286 10MHz", Property, ID_VM_CPU_TYPE0);
    addNode(cpuId, "80286  8MHz", Property, ID_VM_CPU_TYPE1);
    ...
    addNode(dipId, "SW 2-6 (Disable HDD)", Property, ID_VM_DIPSWITCH21);
    addNode(dipId, "SW 2-7", Property, ID_VM_DIPSWITCH22);
    addNode(dipId, "SW 2-8 (GDC 5MHz)", Property, ID_VM_DIPSWITCH23);
