...
Menu::Menu() {
    ...
    addNode(bootId, "MZ-2500", Property, ID_VM_BOOT_MODE0);
    addNode(bootId, "MZ-2000", Property, ID_VM_BOOT_MODE1);
    addNode(bootId, "MZ-80B", Property, ID_VM_BOOT_MODE2);
    ...
    addNode(displayId, "400 Lines, Analog", Property, ID_VM_MONITOR_TYPE0);
    addNode(displayId, "400 Lines, Digital", Property, ID_VM_MONITOR_TYPE1);
    addNode(displayId, "200 Lines, Analog", Property, ID_VM_MONITOR_TYPE2);
    addNode(displayId, "200 Lines, Digital", Property, ID_VM_MONITOR_TYPE3);
    ...
    int filterId = addNode(screenId, "Screen Filter", Category, -1);
