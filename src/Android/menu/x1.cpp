...
Menu::Menu() {
    ...
    int captureScreenId = addNode(hostId, "Capture Screen", Category, -1);
    ...
    addNode(recSoundId, "Rec", Property, ID_HOST_REC_SOUND);
    addNode(recSoundId, "Stop", Property, ID_HOST_REC_STOP);
    addNode(captureScreenId, "Screen", Property, ID_HOST_CAPTURE_SCREEN);
