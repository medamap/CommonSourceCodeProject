...
Menu::Menu() {
    ...
    // Boot メニューを作成
    addNode(bootId, "AUTO START SW: ROM", Property, ID_VM_BOOT_MODE0);
    addNode(bootId, "AUTO START SW: DISK", Property, ID_VM_BOOT_MODE1);
    addNode(bootId, "AUTO START SW: OFF", Property, ID_VM_BOOT_MODE2);
