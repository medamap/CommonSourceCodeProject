...
#define SCREEN_BORDER_WIDTH		(16)
#define SCREEN_BORDER_HEIGHT		(24)
#define SCREEN_WIDTH		(640+SCREEN_BORDER_WIDTH*2)
#define SCREEN_HEIGHT		(400+SCREEN_BORDER_HEIGHT*2)
